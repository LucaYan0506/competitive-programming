...
void solve(){
    ...
    vector<vector<pair<int,int>>> paths; //paths[i] contains the list of pair of nodes that contains node i for the shortest path
    vector<int> preffixShortestPathCost(n+1);//1-indexed
    FOR(i,0,n){
